...
class AsymmetricGANModel(BaseModel):
    ...
    def backward_G(self):
        ...
        # fake_A should fake the discriminator D1
        ...
        # fake_A should fake the discriminator D2
