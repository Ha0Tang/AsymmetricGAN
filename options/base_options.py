...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--ngf_t', type=int, default=64, help='# of translation gen filters in first conv layer')
        parser.add_argument('--ngf_r', type=int, default=4, help='# of reconstruction gen filters in first conv layer')
        ...
        parser.add_argument('--name', type=str, default='ego2top_x_sg2_1', help='name of the experiment. It decides where to store samples and models')
